...
},{"../core-js/object/define-property":"../node_modules/@babel/runtime-corejs2/core-js/object/define-property.js"}],"../compliedJS/fetchApi.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime-corejs2/core-js/json/stringify":"../node_modules/@babel/runtime-corejs2/core-js/json/stringify.js","@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"../node_modules/@babel/runtime-corejs2/helpers/createClass.js","@babel/runtime-corejs2/core-js/object/define-property":"../node_modules/@babel/runtime-corejs2/core-js/object/define-property.js"}],"../compliedJS/getElements.js":[function(require,module,exports) {
"use strict";
...
},{"@babel/runtime-corejs2/core-js/object/define-property":"../node_modules/@babel/runtime-corejs2/core-js/object/define-property.js"}],"../compliedJS/main.js":[function(require,module,exports) {
"use strict";
...
(function () {
  api.getAll('https://young-reef-15976.herokuapp.com').then(function (data) {
    var contentStore = "";
    data.map(function (person) {
      contentStore += "<li class=\"list-group-item name-list\" id=\"".concat(person._id, "\"> Name: ").concat(person.name, "</li>");
    });
    root.innerHTML = "<ul class=\"list-group\">".concat(contentStore, "</ul>");
    var nameList = document.querySelectorAll('.name-list');
    getPerson(nameList);
  });
})();
...
function getPerson(nameList) {
  nameList.forEach(function (li) {
    li.addEventListener('click', /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
      var data;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return api.getOne('https://young-reef-15976.herokuapp.com/getPerson', li.id);

            case 3:
              data = _context.sent;
              data.forEach(function (person) {
                root.innerHTML = "\n                  <ul class=\"list-group\">\n                     <li class=\"list-group-item\">Name: ".concat(person.name, "</li>\n                     <li class=\"list-group-item\">Age: ").concat(person.age, "</li>\n                     <li class=\"list-group-item\">Gender: ").concat(person.gender, "</li>\n                  </ul>\n                  <br />\n                  <button class=\"btn btn-dark\" id=\"editBtn\">Edit</button>\n                  <button class=\"btn btn-danger\" id=\"deleteBtn\">Delete</button>\n               ");
                var editBtn = getElements_1.queryButtonElement('editBtn');
                var deleteBtn = getElements_1.queryButtonElement('deleteBtn');
...
function editPerson(editBtn, person) {
  editBtn.addEventListener('click', function () {
    ...
    root.innerHTML = "\n         <form id=\"editForm\">\n            <div id=\"form-group\">\n               <label for=\"name\">Name</label>\n               <input type=\"text\" class=\"form-control input-elements\" name=\"name\" id=\"name\" value=\"".concat(name ? name : '', "\">\n            </div>\n            <br />\n            <div id=\"form-group\">\n               <label for=\"age\">Age</label>\n               <input type=\"number\" class=\"form-control input-elements\" name=\"age\" id=\"age\" value=\"").concat(age ? age : '', "\">\n            </div>\n            <br />\n            <div id=\"form-group\">\n               <label for=gender\">Gender</label>\n               <input type=\"text\" class=\"form-control input-elements\" name=\"gender\" id=\"gender\" value=\"").concat(gender ? gender : '', "\">\n            </div>\n            <br />\n            <input type=\"submit\" class=\"btn btn-success\" value=\"Submit\">\n            <input class=\"btn btn-dark\" id=\"cancelEditBtn\" value=\"Cancel\">\n         </form>\n      ");
    var editForm = getElements_1.queryFormElement('editForm');
    var editInputElements = getElements_1.queryInputElements(['name', 'age', 'gender']);
    var formBody = getFormInputs(editInputElements);
    var cancelEditBtn = getElements_1.queryButtonElement('cancelEditBtn');
...
(function () {
  ...
  addPersonBtn.addEventListener('click', function () {
    ...
    var inputElements = getElements_1.queryInputElements(['name', 'age', 'gender']);
    var formBody = getFormInputs(inputElements);
...
function getFormInputs(inputElements) {
  ...
  inputElements.forEach(function (elem) {
    elem.oninput = function () {
      var name = elem.name,
          value = elem.value;
      (0, _assign.default)(tempInputStore, (0, _defineProperty2.default)({}, name, value));
    };
  });
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 14:
              ...
              errorMsg = getElements_1.queryHTMLElement('errorMsg');
              errors.forEach(function (err) {
                errorMsg.innerHTML += "\n               <div class=\"alert alert-warning alert-dismissible fade show\" role=\"alert\">\n                  <strong>Validation Error!!!</strong> ".concat(err, "\n                  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">\n                  <span aria-hidden=\"true\">&times;</span>\n                  </button>\n               </div>\n            ");
              });
...
function deletePerson(deleteBtn, _id) {
  deleteBtn.addEventListener('click', /*#__PURE__*/(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4() {
    var data;
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../compliedJS/main.js"], null)
//# sourceMappingURL=/main.4360e102.js.map